          ...
          <div className="gap-2 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2    ">
            <div>
              <iframe
                ...
                src="/images/ข่าวประชาสัมพันธ์/2567/กรกฏาคม/24/1.mp4"
              ></iframe>
            </div>
            <div>
              <iframe
                className="w-full aspect-video ..."
                src="/images/ข่าวประชาสัมพันธ์/2567/กรกฏาคม/24/2.mp4"
              ></iframe>
            </div>
            <div>
              <iframe
                className="w-full aspect-video ..."
                src="/images/ข่าวประชาสัมพันธ์/2567/กรกฏาคม/24/3.mp4"
              ></iframe>
            </div>
            <div>
              <iframe
                className="w-full aspect-video ..."
                src="/images/ข่าวประชาสัมพันธ์/2567/กรกฏาคม/24/4.mp4"
              ></iframe>
            </div>
          </div>
        </div> */}
