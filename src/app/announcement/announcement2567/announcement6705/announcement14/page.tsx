  ...
  return (
    <>
      <div>
        ...
        <div className="pt-8">
          <div>
            <div className="text-lg text-sky-500">👉ระดับ ปวช.</div>
            <iframe
              className="w-full aspect-video ... "
              src="/images/ข่าวประกาศ/2567/พฤษภาคม/4/1.pdf"
            ></iframe>
          </div>
        </div>
        <div className="pt-8">
          <div>
            <div className="text-lg text-sky-500">👉ระดับ ปวส.</div>
            <iframe
              className="w-full aspect-video ... "
              src="/images/ข่าวประกาศ/2567/พฤษภาคม/4/2.pdf"
            ></iframe>
          </div>
        </div>
      </div>
